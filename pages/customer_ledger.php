            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div id="maintable">
                                    ...
                                    <td>&nbsp;</td>
									 ...
									 if($tftft=='')
									 {
										 ...
										 $r=$amount; 
                                            ...
                                            echo '<font style = color:red;>Ksh '.''.formatMoney($r, true).'</font>';
                                            ?></td>
                                </tr>
                                <?php
                                $tftft=$_GET['cname'];
                                ...
                                for($i=0; $row = $result->fetch(); $i++){
                                    ...
                                    <tr class="record">
                                        ...
                                        <td><?php echo $row['invoice']; ?></td>
                                         <td align="right"><?php
                                            $pprice=$row['amount'];
                                            echo 'Ksh '.''.formatMoney($pprice, true);
                                            ?></td>
                                        <td align="right"><?php
                                            $pprice=$row['balance'];
                                            echo 'Ksh '.''. formatMoney($pprice, true);
                        ...
                        <a rel="facebox" id="addd" class="btn btn-primary" href="addledger.php?invoice=<?php echo $_GET['cname']; ?>&amount=<?php echo $amount; ?>" style="margin-top: 10px;">Add Payment</a>&nbsp &nbsp
						  <a rel="" class="btn btn-primary" href="invoiceReceipt.php?id=<?php echo $_GET['cname']; ?>" style="margin-top: 10px;">Print Receipt</a><br><br>
