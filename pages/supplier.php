                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                     ...
                                     <form action="savesupplier.php" method="post" class = "form-group">
                                        <div id="ac">
                                            <span>Supplier : </span><input type="text" required name="name" class = "form-control" />
                                            <span>Contact Person : </span><input type="text"  name="cperson" class = "form-control" />
                                            <span>Address : </span><input type="text"  name="address" class = "form-control" /></br>
                                            <span>Contact : </span><input type="number"  id="phone"  name="contact" class = "form-control" /></br>
                    ...
                    <tbody>
                        ...
                        for($i=0; $row = $result->fetch(); $i++){
                            ...
                            <tr class="record">
								...
								<td> <a class="btn btn-primary" href="supplierproducts.php?id=<?php echo $row['suplier_id']; ?>"> 
                                    <i class = "fa fa-eye"></i>
                                </a> </td>
                                <td><a rel="facebox" class="btn btn-primary" href="editsupplier.php?id=<?php echo $row['suplier_id']; ?>"> <i class="fa fa-pencil"></i> </a>  </td>
                            </tr>
                            <?php
                        }
                        ?>
