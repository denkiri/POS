...
?> 
            ...
            <div class="row footer2">
                ...
                <form class="no-print">
                  <a class = "btn btn-primary" onclick="goBack()" style="font-size:20px";>Back</a>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp     <input type="button" class = "btn btn-primary" style="font-size:20px" value="Print" onClick="window.print()">
                </form>
            </div>
