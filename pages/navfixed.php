...
<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
	<div class="navbar-header">
		...
		<a class="navbar-brand" href="home.php"style="background-color:green;font-size:23.5px;">DELE  POS SYSTEM</a>
	</div>
	<!-- /.navbar-header -->
				...
				<ul class="nav" id="side-menu">
					...
					<li>
						...
						<ul class="nav nav-second-level">
							...
							<li>
							<a rel="facebox" href="select_date.php"><i class="fa fa-book fa-fw"></i>Day sales Report</a>
							</li>
							<li>
					...
					<li>
						...
						<ul class="nav nav-second-level">
							...
							<li>
								<a href="charts.php"> Graph For Cash, Credit and Mpesa</a>
							</li>
							<li>
