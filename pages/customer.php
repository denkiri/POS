                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="savecustomer.php" method="post" class = "form-group">
                                        <div id="ac">
                                            <span>First Name : </span><input type="text" required name="fname" class = "form-control" />
                                            <span>Middle Name : </span><input type="text" required name="mname" class = "form-control" />
                                            <span>Last Name : </span><input type="text" required name="lname" class = "form-control" />
                                            <span>Address : </span><input type="text" name="address" class = "form-control" /></br>
                                            <span>Contact : </span><input type="number"  id="phone"  required name="contact" class = "form-control" /></br>
