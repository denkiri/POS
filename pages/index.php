...
body {
 ...
 <style>
  ...
  background-size: cover;
	...
	<link rel="shortcut icon" href="pos.png">
	<!-- Bootstrap Core CSS -->
    			...
    			<div class="col-md-4 col-md-offset-4">
    				<div class="login-panel panel panel-default">
    					<div class="panel-heading">
    						<h3 class="panel-title"><b>POS System </b></h3>
    					</div>
    					...
    					<div class="tab-content">
    						...
    						<div id="home" class="tab-pane fade in active">
    							...
    							<form method="post" name="admin_form">
    								...
    								<div class="form-group">
										...
										<li><a href="changepassword.php"><i></i>Change Password</a></li>
    						...
    						<div id="menu2" class="tab-pane fade">
    							...
    							<form method="post" name="cashier_form">
    								...
    								<div class="form-group">
    									<input type="password" class="form-control" name="cashier_pass" placeholder="Password"id="myInputb"><br>
