    			...
    			<div class="col-md-4 col-md-offset-4">
    				<div class="login-panel panel panel-default">
    					<div class="panel-heading">
    						<h3 class="panel-title"><b>VALIDUS PHARMACY </b></h3>
    					</div>
    					...
    					<div class="tab-content">
    						...
    						<div id="home" class="tab-pane fade in active">
    							...
    							<form method="post" name="admin_form">
    								...
    								<div class="form-group">
    									<input type="password" class="form-control" name="pass" placeholder="Password" id="myInput"><br>
										<input type="checkbox" onclick="myFunction()">Show Password
    								</div>
									<div class="form-group">
    									<input type="password" class="form-control" name="secret" placeholder="Secret Word" id="myInput"><br>
    								</div>
    								<div class="form-group">
    									<button class="btn btn-block btn-success" id = "btn-login" name = "btn-login">Submit</button>
    								</div>
    	...
    	<script type="text/javascript">
    		jQuery(function(){
    			$('form[name="admin_form"]').on('submit', function(donard){
					...
					var c = $(this).find('input[name="secret"]').val();
    				...
    				if (a === '' && b ===''&& c===''){
    					...
    					.done(function(donard){
    						if (donard == 0){
    							$('#alert-msg').html('<div class="alert alert-danger">Incorrect Secret word!</div>');
    						}else{
    							$("#btn-login").html('<img src="loading.gif" /> &nbsp; Changing password ...');
